...
stationList.add(new Station("s_110ST", new Coordinate(0, 6)));
    stationMap.put("s_110ST", stationList.get(stationList.size() - 1));

stationList.add(new Station("s_116ST", new Coordinate(0, 15)));
...
stationList.add(new Station("s_5AV", new Coordinate(0, 15)));
    stationMap.put("s_5AV", stationList.get(stationList.size() - 1));

stationList.add(new Station("s_4AV", new Coordinate(0, 15)));
    stationMap.put("s_4AV", stationList.get(stationList.size() - 1));

for (Object a : new ArrayList<Object>( Arrays.asList(new String("[(s_110ST.5)]").replaceAll("\\s+|\\(|\\)|\\[|\\]", "").split(",")))) {
